...
public class AppAttachmentRecord extends UpdatableRecordImpl<AppAttachmentRecord> implements Record4<String, String, String, String> {
    ...
    private static final long serialVersionUID = 1495616594;
    ...
    /**
     * Setter for <code>public.app_attachment.content_id</code>.
     */
    ...
    /**
     * Getter for <code>public.app_attachment.content_id</code>.
     */
    ...
    public Field<String> field4() {
        return AppAttachment.APP_ATTACHMENT.CONTENT_ID;
    }
     ...
     */
    public AppAttachmentRecord(String id, String description, String type, String contentId) {
        super(AppAttachment.APP_ATTACHMENT);
