...
import PromiseUITestHome from "./PromiseUITestHome";

const PromiseUITestAlternate = new ViewState("PromiseUITestAlternate", (process, scope) => ({
    ...
    "to-home": {
        to: PromiseUITestHome,
        action: t => console.log("to-home", t)
    }
    ...
    return (
        <Row className="mt-3">
            <Col>
                <h1>promiseUI Test Alternate</h1>
                <ButtonToolbar>
                    <Button
...
export default PromiseUITestAlternate;
