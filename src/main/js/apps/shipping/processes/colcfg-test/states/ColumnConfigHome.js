...
import { ViewState, i18n, DataGrid } from "@quinscape/automaton-js";
import { ButtonToolbar } from "reactstrap";
import { Icon } from "domainql-form";
import GridConfigModal from "../../../../../components/GridConfigModal";

const ColumnConfigHome = new ViewState("ColumnConfigHome", (process, scope) => ({}), props => {
...
export default ColumnConfigHome;