...
import ValidateAsyncDetail from "./ValidateAsyncDetail";
...
const ValidateAsyncList = new ViewState(
    "ValidateAsyncList",
    (process, scope) => ({
        "new-foo": {
            to: ValidateAsyncDetail,
            action: t => {
...
export default ValidateAsyncList;
